...
{
    public interface ISellInvoiceBusiness : IInvoiceBusiness
    {
        SellInvoice FullLoadSellInvoice(int number, SqlConnection connection = null, SqlTransaction transaction = null);
    }
}
