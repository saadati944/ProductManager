...
{
    public class SellInvoicesRepository : ISellInvoicesRepository
    {
        ...
        public SellInvoicesRepository(IDatabase database)
        {
            _database = database;
        }
        ...
        {
            return _database.GetAll<SellInvoiceItem>(connection, transaction, "SellInvoiceRef=" + invoiceid);
        }

        public DataTable GetInvoiceItems(int invoiceid, SqlConnection connection = null, SqlTransaction transaction = null)
        {
            return _database.GetAllDataset<SellInvoiceItem>(connection, transaction, "SellInvoiceRef=" + invoiceid).Tables[0];
        }
    }
