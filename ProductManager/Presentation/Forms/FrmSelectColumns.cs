...
namespace Framework.Presentation.Forms
{
    ...
    {
        private readonly Interfaces.ISettingsBusiness _settings;
        private List<ColumnSelectInfo> _columns;

        public List<ColumnSelectInfo> Columns { get { return _columns; } }

        public FrmSelectColumns(Interfaces.ISettingsBusiness settings)
        {
            InitializeComponent();
            _settings = settings;
            TopLevel = false;
        }
        public void SetColumns(List<ColumnSelectInfo> columns)
        {
            _columns = columns;
            AddCheckboxes();
        }
