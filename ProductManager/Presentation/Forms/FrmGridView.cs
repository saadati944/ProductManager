...
namespace Framework.Presentation.Forms
{
    ...
    {
        protected readonly Interfaces.IDatabase _database;
        protected readonly Interfaces.ISettingsBusiness _settings;
        protected readonly Interfaces.IFormFactory _formFactory;
        protected readonly List<ColumnSelectInfo> _columnSettings = new List<ColumnSelectInfo>();

        public FrmGridView(Interfaces.IDatabase database, Interfaces.ISettingsBusiness settings, Interfaces.IFormFactory formFactory)
        {
            TopLevel = false;
            InitializeComponent();
            _database = database;
