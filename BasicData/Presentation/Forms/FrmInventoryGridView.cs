...
namespace BasicData.Presentation.Forms
{
    public class FrmInventoryGridView : FrmGridView
    {
        ...
        public FrmInventoryGridView(IDatabase database, ISettingsBusiness settings, IMeasurementUnitsRepository measurementUnitsRepository, IStockSummariesRepository stockSummariesRepository, IFormFactory formFactory) :
