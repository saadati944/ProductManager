...
namespace Business
{
    public class BuyInvoiceBusiness : InvoiceBusiness
    {
        ...
        public override bool EditInvoice(int lastNumber, DataTable invoicetable, DataTable invoiceitems)
        {
            ...
            if (ArrayComparator.AreEqual(GetInvoiceVersion(lastNumber, Invoice.InvoiceType.Buying, connection, transaction), invoicetable.Rows[0].Field<byte[]>(Invoice.VersionColumnName))
